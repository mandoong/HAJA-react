export default function LayoutFooter() {
  return (
    <>
      <div className="w-full flex justify-center border-y-[1px]">
        <div className="flex max-w-[1400px] w-full justify-between gap-20 text-sm px-4 pt-4 pb-16 mt-4 text-gray-400">
          <div className="w-56">
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[1400px] text-sm py-20 bg-[#fbfbfb] px-4 text-gray-400">
